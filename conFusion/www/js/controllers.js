...
.controller('DishDetailController',
        ['$scope', '$stateParams', 'dish', 'menuFactory', 'baseURL', '$ionicPopover', 'favoriteFactory', '$ionicModal', '$timeout',
        function($scope, $stateParams, dish, menuFactory, baseURL, $ionicPopover, favoriteFactory, $ionicModal, $timeout) {
    ...
    $scope.addComment = function() {
        $scope.popover.hide();
        $timeout(function() {$scope.commentform.show();}, 0);
    };
